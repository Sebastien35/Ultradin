...
final class Version20250218082147 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE users_verifications (
            id INT AUTO_INCREMENT NOT NULL,
            user_id INT NOT NULL,
            created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\',
            verified_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\',
            verified TINYINT(1) NOT NULL,
            code_verification VARCHAR(512) NOT NULL,
            type_verification VARCHAR(255) NOT NULL,
            INDEX IDX_8563EF4BA76ED395 (user_id),
            PRIMARY KEY(id)
