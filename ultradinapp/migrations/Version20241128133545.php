 ...
 */
final class Version20241128133545 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_address (id INT AUTO_INCREMENT NOT NULL, id_countryiso3 INT NOT NULL, id_user INT NOT NULL, city VARCHAR(255) NOT NULL, zip INT NOT NULL, INDEX IDX_5543718B239457E (id_countryiso3), UNIQUE INDEX UNIQ_5543718B6B3CA4B (id_user), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
